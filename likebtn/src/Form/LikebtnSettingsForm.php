...
class LikebtnSettingsForm extends ConfigFormBase {
  ...
  public function buildForm(array $form, FormStateInterface $form_state) {
    ...
    $form['likebtn_plan'] = array(
      ...
      '#default_value' => $config->get('likebtn_plan'),
      '#options'       => array(
    ...
    $form['likebtn_general_display_options']['likebtn_nodetypes'] = array(
      ...
      '#default_value' => $config->get('likebtn_nodetypes') ?: array(
        'article' => 'article',
        'page' => 'page'
      ),
      '#options'       => $options,
    ...
    $form['likebtn_general_display_options']['likebtn_comments_nodetypes'] = array(
      ...
      '#default_value' => $config->get('likebtn_comments_nodetypes') ?: array(),
      '#options'       => $options,
    ...
    $form['likebtn_general_display_options']['likebtn_view_modes'] = array(
      ...
      '#default_value' => $config->get('likebtn_view_modes') ?: array(
        'full' => 'full',
        'teaser' => 'teaser',
      ),
    ...
    $form['likebtn_general_display_options']['likebtn_weight'] = array(
      ...
      '#default_value' => $config->get('likebtn_weight'),
      '#options'       => array(
        -100 => '-100',
        -50  => '-50',
        -20  => '-20',
    ...
    $form['likebtn_general_display_options']['likebtn_user_logged_in'] = array(
      ...
      '#default_value' => $config->get('likebtn_user_logged_in'),
      '#options'       => array(
        'all' => t('For all'),
    ...
    $form['likebtn_account_data']['likebtn_account_data_email'] = array(
      '#type'          => 'textfield',
      '#title'         => t('Email'),
      '#default_value' => $config->get('likebtn_account_data_email'),
    ...
    $form['likebtn_account_data']['likebtn_account_data_api_key'] = array(
      ...
      '#title'         => t('API key'),
      '#maxlength'     => 32,
      '#default_value' => $config->get('likebtn_account_data_api_key'),
    ...
    $form['likebtn_account_data']['likebtn_account_data_site_id'] = array(
      ...
      '#title'         => t('Site ID'),
      '#maxlength'     => 24,
      '#default_value' => $config->get('likebtn_account_data_site_id'),
    ...
    $form['likebtn_sync']['likebtn_sync_inerval'] = array(
      ...
      '#default_value' => $config->get('likebtn_sync_inerval'),
      '#options'       => array(
        5 => '5',
        15 => '15',
        30 => '30',
    ...
    $form['likebtn_settings_local_domain'] = array(
      ...
      '#default_value' => $config->get('likebtn_settings_local_domain'),
    );
    ...
    $form['likebtn_settings_subdirectory'] = array(
      ...
      '#default_value' => $config->get('likebtn_settings_subdirectory'),
    );
  ...
  public function submitForm(array &$form, FormStateInterface $form_state) {
    ...
    $config->set('likebtn_plan', $values['likebtn_plan'])
      ->set('likebtn_nodetypes', $values['likebtn_nodetypes'])
      ->set('likebtn_comments_nodetypes', $values['likebtn_comments_nodetypes'])
      ->set('likebtn_view_modes', $values['likebtn_view_modes'])
      ->set('likebtn_user_logged_in', $values['likebtn_user_logged_in'])
      ->set('likebtn_account_data_email', $values['likebtn_account_data_email'])
      ->set('likebtn_account_data_api_key', $values['likebtn_account_data_api_key'])
      ->set('likebtn_account_data_site_id', $values['likebtn_account_data_site_id'])
      ->set('likebtn_sync_inerval', $values['likebtn_sync_inerval'])
      ->set('likebtn_settings_local_domain', $values['likebtn_settings_local_domain'])
      ->set('likebtn_settings_subdirectory', $values['likebtn_settings_subdirectory'])
      ->set('likebtn_weight', $values['likebtn_weight'])
      ->save();
